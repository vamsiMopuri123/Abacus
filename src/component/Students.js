...
export default function Students() {
  ...
  return (
    <div>
        <center>
        <h1 className='Lead' style={{background:"green"}}>Students</h1>
        <h2 style={{background:"blue"}}>AddStudent</h2>
        <p className="lead">
        ...
        <h2 style={{background:"blue"}}>ViewStudent</h2>
         <p className="lead">
            <button className="btn btn-success"
        ...
        <h2 style={{background:"blue"}}>EditStudent</h2>
         <p className="lead">
            <button className="btn btn-success"
